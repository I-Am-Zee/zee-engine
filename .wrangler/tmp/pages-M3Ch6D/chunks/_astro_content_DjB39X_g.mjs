...
import { as as objectType, at as dateType, au as arrayType, av as stringType, n as AstroError, aw as UnknownContentCollectionError, c as createComponent, ax as RenderUndefinedEntryError, ar as unescapeHTML, a as renderTemplate, p as escape, ay as renderUniqueStylesheet, az as renderScriptElement, aA as createHeadAndContent, r as renderComponent } from './astro/server_C0Zh7G4i.mjs';
import { b as removeBase, i as isRemotePath, p as prependForwardSlash } from './path_B0nnn-SU.mjs';
import { b as VALID_INPUT_FORMATS } from './consts_C49WwYgi.mjs';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_9GeMhxDJ.mjs');
...
const __vite_import_meta_env__ = {"ASSETS_PREFIX": undefined, "BASE_URL": "/", "DEV": false, "MODE": "production", "PROD": true, "PUBLIC_AFFILIATE": "false", "PUBLIC_BRAND_ID": "zelia-vance", "PUBLIC_RAZORPAY_KEY_ID": "rzp_test_SBluedEOx8ViuP", "PUBLIC_SITE_URL": "https://dev.zeliavance.com/", "PUBLIC_SNIPCART_API_KEY": "YjU0NTAyNDktMGIxOS00NmYwLTkxMTMtMTlmMmMwYWI2ZWU0NjM5MDMwNDY5MzAzOTQ1Nzk3", "SITE": "http://localhost:4321", "SSR": true};
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_astro_assets_D4S6UV3o.mjs').then(n => n._);
...
async function renderEntry(entry) {
  ...
  if (entry.deferredRender) {
    try {
      const { default: contentModules } = await import('./content-modules_Cy1wN81d.mjs');
